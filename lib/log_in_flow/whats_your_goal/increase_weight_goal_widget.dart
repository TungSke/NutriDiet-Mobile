...
class IncreaseWeightGoalScreenWidget extends StatefulWidget {
  const IncreaseWeightGoalScreenWidget({super.key});

  @override
  State<IncreaseWeightGoalScreenWidget> createState() =>
      _IncreaseWeightGoalScreenWidgetState();
}

class _IncreaseWeightGoalScreenWidgetState
    extends State<IncreaseWeightGoalScreenWidget> {
