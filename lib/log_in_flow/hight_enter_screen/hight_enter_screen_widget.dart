...
//   void initState() {
//     super.initState();
//     fetchCurrentHeight(); // Fetch height data if available
//   }
//
//   Future<void> fetchCurrentHeight() async {
//     try {
...
//
//         double apiHeight =
//             double.tryParse(healthData['height'].toString()) ?? 0.0;
//         if (apiHeight > 0) {
//           setState(() {
//             selectedHeightLeft = apiHeight.toInt().toDouble();
//             selectedHeightRight =
//                 (apiHeight - selectedHeightLeft) * 10; // Decimal part (0-9)
//             updateHeightOptions();
//           });
//         }
//       }
//     } catch (e) {
//       print("❌ Lỗi lấy chiều cao từ API: $e");
//     }
//   }
//
